    ...
    <div className={styles.rootCont} id="contact">
      ...
      <Form onSubmit={handleOnSubmit}>
        ...
        <div className={styles.iconsCont}>
          <a href="mailto:ankitakadu131@gmail.com">
          ...
          <a href="https://github.com/Ankikadu" rel="noreferrer" target="_blank">
            <AiOutlineGithub className={styles.gitIcon} />
          </a>
        </div>
        <p className={styles.text}>Phone: 7972946898</p>{" "}
        <p className={styles.text}>Email: ankitakadu131@gmail.com</p>
      </Fade>
    </div>
  )
}
